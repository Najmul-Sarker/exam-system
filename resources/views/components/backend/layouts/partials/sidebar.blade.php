                ...
                <div class="body">
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('ui/backend/assets/images/lg/avatar1.jpg')}}" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{asset('ui/backend/assets/images/xs/avatar2.jpg')}}" alt="">
                                    <div class="media-body">
